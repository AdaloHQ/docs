...
Manifests include several important properties that help inform Adalo which controls to show in the Editor.
...
List of top-level props. See Props

### `childComponents`

- Type: `Array`

List of child components. See Child Components
...
Technical name of the prop. This should be the same as the react component prop name. See [Reserved Prop Names](#reserved-prop-names)
...
The default value of this prop
...
| `color`   | A color string: `#ffffff` or `rgba(255, 255, 255, 1)`                                                                                                                                                      |

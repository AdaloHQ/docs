...
You'll need to have [Node](https://nodejs.org) `>=10.2` on your machine, and you need to [enable developer mode](marketplace/basics/enabling-developer-mode) on your Adalo account. Then to create a component, run:

...
The path to the icon for this component. This will be used as a thumbnail in the Components Panel. See the [thumbnail guidelines](/guidelines/artwork/thumbnails) for information on the logo guidelines.
